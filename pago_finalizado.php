...
<?php include_once 'views/comprador/menu_comprador.php'; ?>
    ...
    <div class="modal fade" id="modal_pago_cecabank_finalizado" tabindex="-1" aria-labelledby="modal_pago_cecabank_finalizadoLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal_pago_cecabank_finalizadoLabel">Notificación de pago</h5>
                </div>
